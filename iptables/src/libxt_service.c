...
static void service_help(void)
{
	printf("service v%s options:\n"
...
static void service_final_check(unsigned int flags)
{
...
static void
service_print(const void *ip, const struct xt_entry_match *match,
	      int numeric)
{
	struct ipt_service_info *info =
	    (struct ipt_service_info *) match->data;
